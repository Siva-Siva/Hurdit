...
$id = $_GET['id']; // gets the id of the comment that is being downvoted
...
CURRENT_TIMESTAMP 
    ...
    if ($direction == -1) { // if the comment has already been downvoted, then it performs the script below
        $vote = $upVotes - $downVotes;
        echo $vote;
    }
